...
import com.spudg.tricrypto.databinding.ActivityAboutBinding
import com.spudg.tricrypto.databinding.DialogTermsOfUseBinding
...
class AboutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bindingAbout.triCryptoDesc.text = getString(R.string.version_by_ss, version.toString())
    ...
    private fun privacyPolicy() {
        val url =
            "https://docs.google.com/document/d/1-XgO1pbeRHryOSX5Ajee11xEkFFqjFp-tQJIR9WaAsQ/edit?usp=sharing"
    ...
    private fun email() {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, "triCrypto - Suggestion / bug report")
    ...
    private fun rate() {
        val url =
            "https://play.google.com/store/apps/details?id=com.spudg.tricrypto"
        val i = Intent(Intent.ACTION_VIEW)
        i.data = Uri.parse(url)
        startActivity(i)
    }
